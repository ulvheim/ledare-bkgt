 ...
 * Description: Displays team statistics and overview for BKGT
 */
...
<div class="bkgt-team-overview">
    <div class="bkgt-container">
        ...
        <header class="bkgt-page-header">
            <h1><?php _e('Lagöversikt', 'bkgt-team-player'); ?></h1>
            <p><?php _e('Statistik och översikt över BKGT laget', 'bkgt-team-player'); ?></p>
        </header>

        <div class="bkgt-team-content">
            <?php echo do_shortcode('[bkgt_team_overview]'); ?>
        </div>
