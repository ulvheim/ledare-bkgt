 ...
 * Description: Displays all BKGT players with detailed information
 */
...
<div class="bkgt-players-page">
    <div class="bkgt-container">

        <header class="bkgt-page-header">
            <h1><?php _e('BKGT Spelare', 'bkgt-team-player'); ?></h1>
            <p><?php _e('Här hittar du alla våra spelare i BKGT', 'bkgt-team-player'); ?></p>
        </header>

        <div class="bkgt-players-content">
            <?php echo do_shortcode('[bkgt_players]'); ?>
        </div>
