...
//         echo '<div class="error"><p><strong>BKGT SWE3 Scraper:</strong> The BKGT Document Management plugin is required but not active. Please activate it first.</p></div>';
//     });
//     return;
// }
...
add_action('plugins_loaded', 'bkgt_swe3_scraper');