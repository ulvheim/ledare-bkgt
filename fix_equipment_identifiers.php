<?php
/**
 * Fix Equipment Item Unique Identifiers
 * Correct the manufacturer assignment for the second football
 */

require_once('wp-load.php');
global $wpdb;

echo "FIXING EQUIPMENT UNIQUE IDENTIFIERS\n";
echo "===================================\n\n";
...
echo "CORRECTING SECOND FOOTBALL ITEM:\n";
echo "---------------------------------\n";

// Find the item with sticker_code = '5-6-1'
...
if (!$item_to_fix) {
    echo "❌ Item with sticker code 5-6-1 not found!\n";
    exit;
}
...
// Change manufacturer from 1 (BKGT) to 6 (No-name)
$new_manufacturer_id = 6;
...
echo "New manufacturer ID: {$new_manufacturer_id} (No-name)\n";
...
echo "-----------------\n";
echo "Football 5-5-1: 0001-0005-00001 (BKGT manufacturer, Footballs, first item)\n";
