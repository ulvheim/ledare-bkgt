...
alert('BKGT admin.js loaded');
console.log('BKGT admin.js starting');

(function($) {
    'use strict';

    $(document).ready(function() {
        console.log('BKGT Data Scraping admin.js loaded');
    ...
    function initTabs() {
        ...
        console.log('Found tab buttons:', $('.bkgt-tab-button').length);
        
        $('.bkgt-tab-button').on('click', function() {
            console.log('Tab button clicked:', $(this).data('tab'));
        ...
        function switchToTab(tabId) {
            console.log('switchToTab called with:', tabId);
            
            // Update ARIA attributes
            $('.bkgt-tab-button').attr('aria-selected', 'false').removeClass('active');
            $('.bkgt-tab-panel').attr('aria-hidden', 'true').hide().removeClass('active').attr('hidden', true);

            // Add active class to clicked tab
            $('.bkgt-tab-button[data-tab="' + tabId + '"]').addClass('active').attr('aria-selected', 'true');

            // Show corresponding panel
            $('#bkgt-tab-' + tabId).addClass('active').attr('aria-hidden', 'false').show().removeAttr('hidden');
